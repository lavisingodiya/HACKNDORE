...
$content .= '
		<tr><td>'.$row['PropertyId'].'</td><td>'.$row['Property'].'</td><td>₹ '.$row['ChargeableFee'].'</td><td>₹ '.$row['BalanceBF'].'</td><td>₹ '.$row['AmountPayable'].'</td><td>₹ '.$row['AmountPaid'].'</td><td>₹ '.$row['CurrentBalance'].'</td></tr>
		';
	}
}else{
$content .= '
