...
if($_POST['cardNum']==NULL){
	...
	$Message->body = "Land & Property Rates Department. You have made a payment on a property Via Mobile Money. Mobile Num: ".$mobile.". Property Num: ".$PropertyId.". Amount Paid: ₹ ".$AmountPaid.". Receipt Num: ".$paymentId.". Ref: ".date('dmy-hmi').". Balance Due: ₹ ".$Balance.". Thankyou for your Payment";
	...
	$Message->originator = '+260979909982';
	$Message->recipients = array(+260979909982);
	$Message->body = "Land & Property Rates Department. You have made a payment on a property Via Visa Card. Card Num: ".$_POST['cardNum'].". Property Num: ".$PropertyId.". Amount Paid: ₹ ".$AmountPaid.". Receipt Num: ".$paymentId.". Ref: ".date('dmy-hmi').". Balance Due: ₹ ".$Balance.". Thankyou for your Payment";
                ...
                if(ISSET($_POST['step2'])){
				  ...
				  <div class="container-fluid">
					<form action="" id="make_payment" method="POST">
					  ...
					  <div class="form-group">
						<label for="Balance" class="control-label">Outstanding Balance(₹)</label>
