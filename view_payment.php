        ...
        <div class="card-body" id="print_div">
            <div class="row">
                ...
                <div class="receipt-main col-xs-12 col-sm-12 col-md-12 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <h3>
                        <center>MUNICIPAL CORPORATION, INDORE</center>
                    </h3>
                    <div class="row">
                    ...
                    <div>
                        <table width="100%" style="border-color: #e4dddd;" border="1">
                            <thead style="background-color: #414143; color:#fff">
                                <tr>
                                    <th style="background-color: #414143; text-align:center;">Tax Description</th>
                                    <th style="background-color: #414143; text-align:center;">Tax Numbers</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right; padding-right:20px;">
                                        <strong><i class="fa fa-inr"></i>₹ <?php echo $rs['Balance'];?></strong>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="footer-text">
                        ...
                        <p>
                            <center>&copy;2024, MUNICIPAL CORPORATION, INDORE</center>
                        </p>
                        <i>
